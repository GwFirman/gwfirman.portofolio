        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <Magnetic>
            <Image
              ...
              width={2048}
              height={2048}
              className="inline-block rounded-md sm:rounded-md border border-white dark:border-gray-500 sm:border-2 shadow-sm sm:shadow-md object-cover size-16 sm:size-20 lg:size-28 flex-shrink-0"
            />
          </Magnetic>
