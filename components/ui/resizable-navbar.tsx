...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      animate={{
        backdropFilter: visible ? "blur(90px)" : "none",
        boxShadow: visible
          ? "0 4px 32px rgba(0, 0, 0, 0.04), 0 2px 12px rgba(0, 0, 0, 0.03), 0 0 0 1px rgba(0, 0, 0, 0.03), 0 1px 0 rgba(255, 255, 255, 0.06) inset"
          : "none",
        width: visible ? "59%" : "100%",
        y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
      ...
      className={cn(
        ...
        visible && "bg-white/90 dark:transparent",
        className,
      )}
    >
      {children}
